...
import { BuyOrderListResolved } from "./BuyOrderListResolved";
...
export const buyOrders = [
  ...
  },
  {
    ...
    createdAt: new Date("2022-09-29T22:09:34+0000"),
    datasetIds: [2, 3],
    countries: ["US"],
    budget: 1250,
  },
  {
    ...
    createdAt: new Date("2022-09-26T21:09:34+0000"),
    datasetIds: [4],
    countries: ["US", "GB", "CA"],
    budget: 100,
  },
